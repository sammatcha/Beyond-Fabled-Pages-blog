...
export default function header(){
    return(
        <div className='min-w-full container relative overflow-hidden z-40'>
            <div className="flex flex-col min-w-full relative border border-neutral-200 min-h-[500px] bg-gradient-to-b from-[#1E293B] via-[#2C3E50] to-[#3498DB] lg:grid lg:grid-cols-2">
